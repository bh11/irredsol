...
\beginitems
Version 1.4.7 &
	switch to new NC versions of PreImages and related functions for GAP 4.17, removed references to primgrp as older library of irreducible soluble groups was removed
	
Version 1.4.6 &
	fix bug in PackageInfo.g
	
Version 1.4.5 &
	switch distribution to .tar.gz for better compatibility,  improve compatibility with --bare option
