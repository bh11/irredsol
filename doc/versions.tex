...
Version 1.3 &
	adds groups with $1\,000\,000 \leq q^n \leq 2\,000\,000$, faster recognition, faster computation of block systems, fixes performance regression due to changes in {\GAP} 4.8
