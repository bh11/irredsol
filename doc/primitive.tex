...
primitive solvable groups with given properties, see Sections~"Finding primitive pc groups
...
\>PrimitiveSolvablePermGroup(<n>,<q>,<d>,<k>) F

These functions return the primitive solvable pc group resp. primitive solvable permutation group corresponding to 
`IrreducibleSolvableMatrixGroup(<n>,<p>,<d>,<k>)', where <n> is a positive integer, <p> is a prime, <d> divides <n>
and <k> occurs in the list `IndicesIrreducibleSolvableMatrixGroups(<n>,<p>,<d>)' (see "IndicesIrreducibleSolvableMatrixGroups").
