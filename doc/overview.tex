...
Note that until version 4.16, {\GAP} contained another library consisting of all $372$ irreducible soluble
...
{\IRREDSOL} package provides functions to identify the groups in the former
