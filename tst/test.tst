...
gap> RequirePackage ("irredsol");
true
#gap> SetInfoLevel (InfoIrredsol, 4);
#gap> TraceMethods (MinimalBlockDimensionOfMatrixGroup);
#gap> TraceMethods (IsPrimitiveMatrixGroupOp);
